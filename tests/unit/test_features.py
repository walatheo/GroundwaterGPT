...
class TestFeatureCreation:
    ...
    def test_lag_features_shifted_correctly(self, sample_groundwater_data):
        ...
        from train_groundwater import create_features, FORECAST_HORIZON, LAG_DAYS
    ...
    def test_feature_count_consistent(self, sample_groundwater_data):
        ...
        feature_cols = [c for c in result.columns if c not in ['date', 'water_level', 'month', 'day_of_year']]
